...
function abrir_pagina_3() {
  ...
  if (opcionesSeleccionadas.length === 6) {
    console.log("Se eligieron los 6 colores");
    window.location.href = './para6jugadores.html';

  } else if (opcionesSeleccionadas.length === 5) {
    ...
    if (opcionesSeleccionadas.includes('Verde')) {
      console.log("Entro Verde")
      box_jugador5.style.display = 'block';
      placa_jugador_verde.style.display = 'block';
    }

    if (opcionesSeleccionadas.includes('Marrón')) {
      console.log("Entro Marrón")
      box_jugador6.style.display = 'block';
      placa_jugador_marron.style.display = 'block';
    }

    pagina_2.style.display = 'none';
    pagina_3.style.display = 'block';
    reproducirMusica() //Arranca a sonar la Musica de Fondo.

  } else if (opcionesSeleccionadas.length <=4){
    alert('Debe seleccionar al menos 5 o 6 Casillas para Continuar');
